    ...
    .then(response=>{
        ...
        if(userData.type=='patient'){
            ...
            .then(response2 => {
                ...
                .then(response3 => {
                    DayToDayGoal.create({user:response._id, totalCalories: 0, totalWaterGlasses: 0, caloriesGoalReached: Boolean(false), waterGoalReached: Boolean(false)})
                    .then(response4 =>{
                        ...
                        .then(response5 =>{
                            Admin.create({
                                ...
                                console.log("Patient Successfully signed up updated in admin")
                            }).catch(err=>{
                                ...
                                "data": {
                                    ...
                                    "patientData": {
                                        ...
                                        "caloriesGoal": response3.caloriesGoal ? response3.caloriesGoal : null,
                                         "waterGoal": response3.waterGoal ? response3.waterGoal : null,
                                         "currentECG": " ",
...
router.get('/login', async (req,res)=>{
    ...
    .then(response=>{
        ...
        if(response.type == 'patient'){
                    ...
                    .then(response4 =>{
                        ...
                        .then(response5 =>{
                            Admin.create({
                                ...
                                console.log("Patient Successfully signed in updated in admin")
                            }).catch(err=>{
                                console.log("Admin Error") 
                                res.status(401).send(`Admin Error:${err.message}`)
                            }) 
            ...
            Doctor.findOne({userId:response._id}).exec()
            .then(response5 => {
                Admin.create({
                    user:response._id,
